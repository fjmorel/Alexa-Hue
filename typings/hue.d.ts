// Typings from pull request #85 by wind-rider
// https://github.com/peter-murray/node-hue-api/pull/85
// todo: submit types to DefinitelyTyped
...
declare module "node-hue-api" {
    ...
    export class HueApi {
         ...
         * @return A promise that will set the specified state on the light, or {null} if a callback was provided.
         */
        getGroup(id: string | number): Promise<HueLightGroup>;
        group(id: string | number): Promise<HueLightGroup>;
         ...
         * @return A promise that will return the results or <null> if a callback was provided.
         */
        scenes(): Promise<HueScene[]>;
        getScenes(): Promise<HueScene[]>;
